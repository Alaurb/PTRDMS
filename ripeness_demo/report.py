...
const modeButton=document.createElement('button');modeButton.textContent='View: observation groups';modeButton.onclick=()=>{coordinateMode=!coordinateMode;modeButton.textContent=coordinateMode?'View: recorded coordinates':'View: observation groups';draw()};document.querySelector('.main-panel h2').after(modeButton);
